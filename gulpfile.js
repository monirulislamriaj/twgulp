...
function devVendor(){
  return src(`${options.paths.src.vendor}/**/*`).pipe(dest(options.paths.dist.vendor));
}
...
function prodVendor(){
  return src(options.paths.src.vendor + '/**/*').pipe(imagemin()).pipe(dest(options.paths.build.vendor));
}
